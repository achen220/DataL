...
function PentagonalGraph (props) {
  ...
  useEffect(() => {
    ...
    const polygonlength: number = 500;
    ...
    const labelData = [
      ...
      { x: (polygonlength / 2) - halfFaceSize + margin, y: 500 + margin + 25, label: "CS" },
      { x: (polygonlength / 2) + halfFaceSize + margin, y: 500 + margin + 25, label: "Death" },
      { x: 500 + margin, y: dropHeight + margin, label: "Kill Participation" },
    ];
